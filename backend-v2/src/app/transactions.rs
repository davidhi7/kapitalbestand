...
mod tests {
    ...
    fn test_create_instance(pool: PgPool) -> anyhow::Result<()> {
        ...
        let result = OneoffTransaction::create(
            ...
            OneoffTransactionCreateParams {
                ...
                amount: 1,
                description: None,
                category_id: UnvalidatedCategoryId(category.id),
                shop_id: None,
            },
        )
        .await?
    ...
    fn test_create_instance_with_shop(pool: PgPool) -> anyhow::Result<()> {
        ...
        let result = OneoffTransaction::create(
            ...
            OneoffTransactionCreateParams {
                ...
                description: None,
                category_id: UnvalidatedCategoryId(category.id),
                shop_id: Some(UnvalidatedShopId(shop.id)),
            },
        )
        .await?
        .expect("Failed to create oneoff transaction");
    ...
    fn test_create_invalid_category_id(pool: PgPool) -> anyhow::Result<()> {
        ...
        OneoffTransaction::create(
            ...
            OneoffTransactionCreateParams {
                ...
                amount: 1,
                description: None,
                category_id: UnvalidatedCategoryId(999999),
                shop_id: None,
            },
        )
        .await
        ...
        OneoffTransaction::create(
            ...
            OneoffTransactionCreateParams {
                ...
                amount: 1,
                description: None,
                category_id: UnvalidatedCategoryId(16),
                shop_id: None,
            },
        )
        .await
    ...
    fn test_create_invalid_shop_id(pool: PgPool) -> anyhow::Result<()> {
        ...
        OneoffTransaction::create(
            ...
            OneoffTransactionCreateParams {
                ...
                description: None,
                category_id: UnvalidatedCategoryId(category.id),
                shop_id: Some(UnvalidatedShopId(999999)),
            },
        )
        .await
        ...
        OneoffTransaction::create(
            ...
            OneoffTransactionCreateParams {
                ...
                description: None,
                category_id: UnvalidatedCategoryId(category.id),
                shop_id: Some(UnvalidatedShopId(16)),
            },
        )
        .await
    ...
    fn test_fetch_with_valid_category_filter(pool: PgPool) -> anyhow::Result<()> {
        ...
        let category = get_category_by_name(&pool, user.id, "Groceries").await;
        let params = OneoffTransactionQueryParams {
            category_id: Some(UnvalidatedCategoryId(category.id)),
            ..Default::default()
        };
    ...
    fn test_fetch_with_invalid_category_id(pool: PgPool) -> anyhow::Result<()> {
        ...
        OneoffTransaction::fetch(
            ...
            &user,
            OneoffTransactionQueryParams {
                category_id: Some(UnvalidatedCategoryId(999999)),
                ..Default::default()
            },
            Pagination::default(),
        )
        ...
        OneoffTransaction::fetch(
            ...
            &user,
            OneoffTransactionQueryParams {
                category_id: Some(UnvalidatedCategoryId(14)),
                ..Default::default()
            },
            Pagination::default(),
        )
    ...
    fn test_fetch_with_other_users_category_id(pool: PgPool) -> anyhow::Result<()> {
        ...
        let params = OneoffTransactionQueryParams {
            category_id: Some(UnvalidatedCategoryId(bob_category.id)),
            ..Default::default()
        };
    ...
    fn test_fetch_with_valid_shop_filter(pool: PgPool) -> anyhow::Result<()> {
        ...
        let shop = get_shop_by_name(&pool, user.id, "Whole Foods").await;
        let params = OneoffTransactionQueryParams {
            shop_id: JsonField::Defined(Some(UnvalidatedShopId(shop.id))),
            ..Default::default()
        };
    ...
    fn test_fetch_with_invalid_shop_id(pool: PgPool) -> anyhow::Result<()> {
        ...
        OneoffTransaction::fetch(
            ...
            &user,
            OneoffTransactionQueryParams {
                shop_id: JsonField::Defined(Some(UnvalidatedShopId(999999))),
                ..Default::default()
            },
            Pagination::default(),
        )
        ...
        OneoffTransaction::fetch(
            ...
            &user,
            OneoffTransactionQueryParams {
                shop_id: JsonField::Defined(Some(UnvalidatedShopId(16))),
                ..Default::default()
            },
            Pagination::default(),
        )
    ...
    fn test_fetch_with_other_users_shop_id(pool: PgPool) -> anyhow::Result<()> {
        ...
        let params = OneoffTransactionQueryParams {
            shop_id: JsonField::Defined(Some(UnvalidatedShopId(bob_shop.id))),
            ..Default::default()
        };
    ...
    fn test_update_valid_category_id(pool: PgPool) -> anyhow::Result<()> {
        ...
        let updated_instance = OneoffTransaction::update(
            ...
            1,
            OneoffTransactionUpdateParams {
                category_id: Some(UnvalidatedCategoryId(4)),
                ..Default::default()
            },
        )
        .await?
    ...
    fn test_update_valid_shop_id_some(pool: PgPool) -> anyhow::Result<()> {
        ...
        let updated_instance = OneoffTransaction::update(
            ...
            1,
            OneoffTransactionUpdateParams {
                shop_id: JsonField::Defined(Some(UnvalidatedShopId(4))),
                ..Default::default()
            },
        )
        .await?
